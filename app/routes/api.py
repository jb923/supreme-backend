...
def signin_user():
    ...
    if user.check_password(data['password']):
        if user.first_name == 'demo':
            ...
            transaction4 = Transaction(products=[3, 27, 30, 47], user_id=2, total=101200)
            transaction5 = Transaction(products=[52, 35], user_id=2, total=20600)
            transaction6 = Transaction(products=[40, 62], user_id=2, total=21600)
